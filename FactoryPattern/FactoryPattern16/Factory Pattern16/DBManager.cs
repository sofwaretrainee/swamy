...
namespace Factory_Pattern16
{
    ...
    {
        private Factory_Pattern16.DataAccessHandler.DatabaseHandlerFactory dbFactory;
        private IDatabaseHandler database;
        private string providerName;

        public DBManager(string connectionStringName)
        {
            dbFactory = new Factory_Pattern16.DataAccessHandler.DatabaseHandlerFactory(connectionStringName);
        ...
        public DataSet GetDataSet(string commandText, CommandType commandType, IDbDataParameter[] parameters)
        {
            using (var connection = database.CreateConnection())
            {
                connection.Open();
